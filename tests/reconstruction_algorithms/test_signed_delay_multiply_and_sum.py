...
from image_reconstruction.reconstruction_algorithms.signed_delay_multiply_and_sum import \
    SignedDelayMultiplyAndSumAlgorithm


class TestDelayMultiplyAndSum(TestClassBase):

    def test_delay_multiply_and_sum_reconstruction_is_running_through(self):
        reco = SignedDelayMultiplyAndSumAlgorithm()
