...
class SignedDelayMultiplyAndSumAlgorithm(ReconstructionAlgorithm):
    ...
    def implementation(self, time_series_data: np.ndarray,
                       ...
                       **kwargs):
        """
        Implementation of the signed delay multiply and sum algorithm.
        ...
        values, n_sensor_elements = self.compute_delay_and_sum_values(time_series_data,
                                                                      sensor_positions,
        ...
        delay_and_sum_result = torch.sum(values, dim=3)
        ...
        output = torch.sign(delay_and_sum_result) * output
